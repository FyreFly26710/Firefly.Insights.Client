...
export const GenerateTopicArticlesForm = ({ onSubmit }: Props) => {
  ...
  const filteredCategories =
    options.categories?.filter((c) => c.id !== -1) ?? [];
    ...
    >
      ...
      >
        ...
        <Typography variant="body2" component="div">
          <ul style={{ margin: 0, paddingLeft: 20 }}>
            ...
            <li>
              A job will be dispatched to generate summaries, then articles, and
              a final topic summary.
            </li>
          </ul>
        </Typography>
      </Paper>
      ...
      <Flex width="100%" gap={12}>
        ...
        <LookupFormSelect
          ...
          placeholder={
            watched.watchedProvider ? "Select a model" : "Select provider first"
          }
        />
        <Controller
          name="articleCount"
